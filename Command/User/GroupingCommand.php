 ...
 */
class GroupingCommand extends ContainerAwareCommand
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        $this->setName('security:user:grouping')
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        if ($user->hasGroup($groupName)) {
            $output->writeln(sprintf('User "%s" did already have "%s" Group.', $userName, $groupName));
        ...
        $output->writeln(sprintf('Group "%s" has been added to user "%s".', $groupName, $userName));
    }
