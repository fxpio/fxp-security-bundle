 ...
 */
class AclGroupAddUserCommand extends ContainerAwareCommand
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        $this->setName('acl:group:add:user')
        ->setDescription('Add user in group')
        ->setDefinition(array(
                new InputArgument('group-name', InputArgument::REQUIRED, 'The group name'),
                new InputArgument('user-name', InputArgument::REQUIRED, 'The user name to associated in group'),
         ));
    }
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        try {
            ...
            $output->writeln(array('', "The user <info>$userName</info> was successfully associated with group <info>$groupName</info>"));
